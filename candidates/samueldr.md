...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/472#issuecomment-3361103708">link</a>)</summary>

This only matters assuming that the vote must *pass*, and that a deadlock (equal number of votes) would be considered as *not passing*.

I'm not well-versed in terminology for procedural stuff, and I don't know what rules the SC follows regarding this. So bear with me.

Assuming there is no backdoor where for example “that since consensus could be reached, the committee throws away the vote”, then voting for confidence will necessarily tilt the scales the other way.

In my opinion, it makes sense to go with a solution that necessitates a clear statement that the committee is confident with itself. And if the best way to ensure this *result* is to flip the question around, then yes, the vote should be for confidence.
</details>
...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/477#issuecomment-3363892803">link</a>)</summary>

I personally believe that when a participant of a community is suspended from a community, that they should refrain from interacting with ***the community***.

Note that this is not intended to imply that they cannot interact with the people that they would usually interact with. Or live their life as they would otherwise. Only that they respect the suspension of said community.

I personally believe that such actions betrays the thinking that consequences of actions should not apply to themselves, or that they do not value a safe community for other participants.

I do not know that I would feel safe participating in a community where evading consequences in this manner is tolerated, and I couldn't recommend to anyone to participate under those circumstances.
</details>
