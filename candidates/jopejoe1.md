...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/472#issuecomment-3359957596">link</a>)</summary>

I'm in favor of turning it into a vote of confidence.
</details>
...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/474#issuecomment-3396379982">link</a>)</summary>

There is not much the SC can do in this case, as talks with the `nixos.wiki` have repeatedly failed. Going and applying for a trademark and using that to shut down it down feels like a too big hammer which could also lead to people fearing to use the NixOS name in their projects e.g. NixOS-factor or nix-darwin. What we properly could do is to talk to some services and ask them to use the official wiki for their features, like for example DuckDuckGo's bang still using `nixos.wiki` and not `wiki.nixos.org`. What we also should do is to encourage the usage of `wiki.nixos.org` in the community.
</details>
...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/407#issuecomment-3391896874">link</a>)</summary>

I think meeting notes should be made public only with redaction due to privacy concerns and legal reasons. I also think that some observers should be added to the meeting.
</details>
...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/405#issuecomment-3391917619">link</a>)</summary>

Getting a piece of software that is difficult to build from source to compile and not needing to include a binary blob, and also getting more configs to be generated from Nix code.
</details>
...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/428#issuecomment-3396505558">link</a>)</summary>

My alignment on this issue is very close @pluiedev's and @nyabinary's view on this issue that the moderation team should mainly be there de-escalate conversations that went down a harmful way, and keeping the community healthy. And I think that this happening transparently is one of the most important points when it goes about cultivating a healthy community.
I also think what @rhendric talked about in his post would be a good idea.
</details>
...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/488#issuecomment-3396523674">link</a>)</summary>

I would not sign that, I feel like it would suck away all the fun I have when working on nixpkgs and the community around it.
</details>
