...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/472#issuecomment-3358229729">link</a>)</summary>

Yes, I support this change. I also think we need a requirement for replacing members, as having a full group is best. 
</details>
...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/190#issuecomment-3358819145">link</a>)</summary>

I would handle the situation similar to any other employer. We have [Conflict of Interest](https://github.com/NixOS/org/blob/main/doc/constitution.md#conflict-of-interest-coi-balance) rules spelled out in the constitution, and the SC needs to enforce those even as people change jobs mid-term. Those rules limit the number of members with the same CoI to two, and ensuring that isn't violated is what matters most according to the constitution.

Regarding how to handle publicizing, I'd be happy to work with the other members to create formal or informal rules.
</details>
...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/474#issuecomment-3361086085">link</a>)</summary>

I'm not sure there's much the SC can do. If the owner of nixos.wiki is still uninterested in working with the community to transition to the official wiki, the SC would have little to no power in making things better. Open to ideas though, and happy to delegate if there are workable solutions.
</details>
...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/434#issuecomment-3358751567">link</a>)</summary>
...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/326#issuecomment-3358773967">link</a>)</summary>

I agree with with K900 said, and would add that moving from GitHub also will likely have financial implications. We are more and more leveraging Actions for a non-trivial amount of free compute in our CI jobs. While this is also a risk in itself, we can't ignore the potential costs if we willingly choose to leave.

While I'd love to see us use an alternative, I have to agree that it's likely not a feasible move any time soon. 
</details>
...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/265#issuecomment-3358787584">link</a>)</summary>

I would not change the size, no. We should definitely be able to make 7 work, and reducing the size could reduce the diversity of the body.
</details>
...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/470#issuecomment-3378022197">link</a>)</summary>
...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/464#issuecomment-3356180409">link</a>)</summary>

I'm not sure how I feel about any of the analogies, because I don't think they cleanly apply to the moderation team. In one sense, they're jurists tasked with interpreting the community rules and an individual's behavior with respect to those rules. There can be grey areas, which is why it does require interpretation and not just application of some clearly spelled out rules. On the other hand they are also tasked with enforcing the punishment once the ruling has been made, which is more akin to law enforcement. But it's not strictly law enforcement because the moderation team can, should, and in my understanding does, attempt to guide behavior back towards community norms before it even reaches the level of punishment.

I think we must trust moderators to hold these powers and properly apply them, just as we should delegate powers to other teams in the community. We cannot and should not have the SC spending their time micro-managing any teams, especially the moderation team. That said, I don't think the moderation team (or any team!) should be fully independent with no accountability to the democratic process we have started with the SC. In democracies judges are typically appointed by the representatives or directly elected by voters, while law enforcement are typically hired and can be fired. 

Working with the SC and the community, I would like to see us create checks and balances for most teams and especially for difficult or permanent moderation decisions that the moderation team is tasked with making. A couple ideas that I have are instituting a review/appeals process and clarifying how moderators are approved, appointed, and even removed. In order to ensure we are properly providing privacy to individuals, even if they have violated our community rules, any appeals/review process should be done privately with full information regarding the incident at hand.
</details>
...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/336#issuecomment-3358761478">link</a>)</summary>

The Foundation is currently handling sponsorship of this, here's the latest update:

https://discourse.nixos.org/t/2025-s3-sponsorship-more-resources-for-a-sustainable-nix/67019
https://discourse.nixos.org/t/nixos-foundation-update-july-2025/67803

Regarding what the SC could/should do? Maybe we could empower one or more teams to tackle improvements to the cache, cleanup, or other efficiency steps. I think some of this work may actually be happening, but making it more formal could make it more visible.
</details>
...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/479#issuecomment-3378485483">link</a>)</summary>

I think transparency is good, and candidates should disclose if they're forming an alliance/party, but I don't think we should require it. Elections should be non-partisan, even if members engage in alliances. 
</details>
