...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/472#issuecomment-3360233070">link</a>)</summary>

**TLDR: Yes, I agree that this 3v3 situation is a situation of no-confidence.**

I am uncertain about the specific proposal here. I think the vote of no-confidence puts the burden on the members that think the legitimacy of the SC is void to prove they have the votes. This favors stability: the SC can continue to function until no-confidence has been proved.

On the other hand, a vote of confidence essentially challenges members to come up with 4 votes to prove SC is still legitimate. Until those 4 votes have been gathered the SC is not legitimate to function. The difference is subtle, but it matters in situation where a member is not voting (for reason X or Y). In 3v3 situations where another member has not yet voted, the SC is stuck (it is not legitimate to operate as there is no majority for the confidence), but the vote is also undeterminate. In that case, the vote of confidence doesn't give the benefit of the doubt to the SC, and I am not sure this is right.

One solution that came out of the discussion with @wolfgangwalther is to keep the vote of no-confidence (burden of proof is still on the people in favor of disbanding the SC), but the vote of no-confidence passes with >=50% of votes, which means 3v3 when everybody voted is no-confidence.

I don't think we have to decide right now exactly how this can be implemented though, I just think whoever is going to implement it needs to carefully consider how to implement this not to create deadlocks or disbandments that do not faithfully represent the entire Committee in case a member is temporarily unable to vote. 
</details>
...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/190#issuecomment-3394188322">link</a>)</summary>

Conflicts of Interest declarations from SC members must be updated when they evolve, and transparently communicated to the community. If the SC member joining Anduril creates a Conflict of Interest imbalance, [constitution mandates that they or the other member with same CoI resigns](https://github.com/NixOS/org/blob/main/doc/constitution.md#conflict-of-interest-coi-balance).
</details>
...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/474#issuecomment-3388609132">link</a>)</summary>

As one of the people that participated in the creation of the official wiki, I can say that loads of non-conflictual solutions have been tried with the owner of nixos.wiki before resorting to making a competing wiki.

I don't see a lot of solutions to the problem other than encouraging people to contribute to the official wiki and progressively make it way more informative and updated than the other one.

This situation though is exactly why we need to continue to work on registering a trademark for the Nix/NixOS brand and agree on a trademark policy: so that it's not possible to use the Nix brand in a way that creates confusion between official and non-official resources/products. Collaborating with the Foundation on this and working towards a trademark policy for the community is one of the measures of my platform. 

Note: Trademarks are usually non retroactively applicable so even a trademark might not salvage this particular situation but it may prevent future ones.
</details>
...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/434#issuecomment-3394143112">link</a>)</summary>

Yes definitely, this is part of my platform. I also plan to release personal reports of what are the topics the SC is working on and my position on them, to be as transparent as possible with the community.
</details>
...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/265#issuecomment-3394175263">link</a>)</summary>

I don't think answering this question without having a first-hand experience of the dynamics inside the Steering Committee makes a lot of sense. The only real testimony about the issues that prevent the SC to work efficiently is [this blogpost from Gabriella](https://www.haskellforall.com/2025/09/steering-committee-retrospective.html), that I consider to be an invaluable resource. I am determined to implement all the changes necessary to make our governance model sustainable on the long run, changing the number of seats to 5 is one of those potential changes, but it will surely be put in perspective with my experience if I get elected.
</details>
...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/407#issuecomment-3394224601">link</a>)</summary>

Transparency is crucial for two main reasons: 
- It gives the community a window into what the SC is working on. When decisions are understood better they are accepted better. One of the reasons the decision to remove a moderator created so much conflict in the community is because it *looked* (and is till looking) arbitrary. Good and regular communication helps avoid this and helps preserving the trust in the governance.
- It creates individual members accountability towards their electors. When votes and minutes are made public you have to be faithful to your personal engagements.

For those reasons, my platform includes publications of votes and minutes, and informal communication to the community to keep the public informed on my positions on topics on the SC agenda.
</details>
...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/470#issuecomment-3393216892">link</a>)</summary>

No, I am not part of any coalition. My platform I came up with independently and all my answers are my own. 

That being said, I think discriminating between ~25 candidates and understanding where everyone is standing is very difficult. In an attempt to bring some clarity to the elector, I have written [an extensive blogpost on the reasons behind my candidacy and my platform](https://luj.fr/blog/my-hopes-and-plans-for-nixos.html), and on my candidate form I have given a few names of people I think I am broadly in alignment with and I feel I could work productively with. 
</details>
...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/485#issuecomment-3393733333">link</a>)</summary>

It's pretty clear to me from my regular monitoring of such informational bubbles that there exists some groups of people that would not be unhappy to "take over" the NixOS project. 

My approach to this question is to not be naive and continue improving our governance model to make it as resilient as possible against malicious external actors pulling moves to gain meaningful influence over the project. On the other hand, we have to remember that there is not much we can do about people seemingly plotting against the health of the project in non community spaces and not waste too much energy about it.

That being said, if you are concerned about the risk of malicious external actors trying to influence our community, consider voting for candidates that they explicitly would not want to see winning (like me):

![image](https://github.com/user-attachments/assets/94b92ce0-6ffb-4fce-bf9d-c979f9047feb)
</details>
...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/481#issuecomment-3393626413">link</a>)</summary>

I think the best democratic outcome to a SC member resigning early is to organize special elections. The fact this was not done for the resignation in the current mandate probably goes to show that the constitution must be more constraining on that aspect.
</details>
...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/342#issuecomment-3394167205">link</a>)</summary>

I am in favor of pursuing a clear sponsorship policy, where some entity (maybe SC, maybe SC + moderation, maybe something else to be clarified) has to make a judgement on each sponsor, but also agree on some guidelines that this entity must follow to make their judgement and that require supermajority of the SC to change. These guidelines should ensure we never get a sponsor whose values are so opposed with those of our community that it creates outrage and makes some of our contributors leave the project (eg. military industry).
</details>
...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/340#issuecomment-3394145540">link</a>)</summary>

Registering trademark is ultimately the Foundation's purview, but I'll coordinate with the board to ensure this topic is prioritized and we make some progress on it. I'll also make the elaboration of a trademark *policy* an item of the SC agenda.
</details>
