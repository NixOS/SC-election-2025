...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/472#issuecomment-3359719614">link</a>)</summary>

Agreed, though I'd also like to see a process for filling empty seats quickly, as there will likely be deadlocks that are not worth reaching for the measure of last resort.
</details>
...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/190#issuecomment-3350761785">link</a>)</summary>

On disclosing conflicts of interest - agree with everything that's been said pretty much. On codifying this into a rule - I believe that it's important to have the rule not because we _need_ it, but because it is a strong commitment of intent.
</details>
...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/326#issuecomment-3350875400">link</a>)</summary>

Right now? No, I don't think so. Github is absolutely a mess, but no other forge has been shown to successfully scale to nixpkgs sizes (and believe me, we've tried). Now, the Gerrit folks and the Forgejo folks have both been working on improving performance for very large repos, and have gotten promising results, so there's definitely potential for this in the future, but before we commit to anything, I'd like to be reasonably confident that what we're committing to will actually work.
</details>
...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/477#issuecomment-3362492049">link</a>)</summary>

To add to what has already been said, this person's suspension was directly related to their attempts to concern troll the election process, and they have publicly endorsed individual candidates on their social media. They are not a neutral third party and they either choose to engage anyway, or are completely oblivious to that fact, and I don't know what is worse.
</details>
...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/405#issuecomment-3350974204">link</a>)</summary>

I've been in the community for many years now, first as a user, then as a maintainer, then as a team member and now I guess as an SC candidate, and I've also been in other free software communities for much longer than this. What really blows my mind is how often I see people in those other communities, running other systems, run into issues that just fundamentally, by design, don't exist on NixOS. I wouldn't say this brings me _joy_, per se, because I have to then stop myself from yelling "BUT NIXOS FIXES THIS" at my screen, and I wish I could tell people that without also qualifying it with "if you don't mind the community being permanently on fire, anyway".
</details>
...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/192#issuecomment-3350789476">link</a>)</summary>

The way it is defined right now, the SC is the supreme authority over all things in the ecosystem, so any potential "conflicts of interest" can only exist between SC and teams subordinate to SC, which is arguably not an issue as long as the goals of SC and the teams are sufficiently aligned (which they generally should be). However, if we change the structure in ways where there are multiple leadership groups that provide counterbalance to one another, the conflicts of interest that arise there could become a problem, and we'll have to design the system in a way that either prevents them from happening or ensures they don't lead to deadlocks.
</details>
...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/390#issuecomment-3350934454">link</a>)</summary>

(speaking as someone who wrote those words) 

I think a good start would be a system similar to what the Rust folks implemented, where the Leadership Council and the Community Team have a mechanism for mutually assured destruction in case one side completely loses confidence in the other. I think I'd like to see this extended to some sort of technical steering body as well, because it's not the SC's job to make individual technical decisions, but the impact of those decisions on the project can be massive, and people that are trusted to make those decisions need to also be subject to checks and balances. 
</details>
...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/195#issuecomment-3350814740">link</a>)</summary>

Publish notes from every SC meeting I'm allowed into, set up an interim moderation structure, start drafting a constitutional amendment that provides teams with specific mechanisms to push back against an unaligned SC (and likely gives away some of the SC's power entirely).
</details>
...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/488#issuecomment-3367973190">link</a>)</summary>

> ...I believe that as a community we are here to do our best work and to ship code.

I absolutely don't, no. "Shipping code" is not the end goal, not for "the community", and not for any of us. "Shipping code" is a tool to solve problems, and what problems are being solved is inherently - oh no! avert your eyes! - political. Also, there's just something about "shipping code" as an end goal that gives me deeply uncomfortable Silicon Valley LinkedIn grindset vibes, and I don't want this community to become that.

As for the rest of the pledge, this is a pretty clear - oh no! - political play. "We commit to unconditional support for The Powers That Be because they Are" is exactly how we get institutions that are not performing their intended function and acting against the community's interests - trust me, I've [lived through this](https://en.wikipedia.org/wiki/Human_rights_in_Russia).
</details>
...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/436#issuecomment-3351754535">link</a>)</summary>

I don't think it really makes sense to pursue a single, unambiguous definition of who "the community" is. If we consider "the community" to be anyone who uses Nix or interacts with it, then sure, all of those entities and people are part of "the community". If we consider "the community" to be people that are eligible to be involved in the election process, then Anduril isn't part of "the community" simply because a corporation can't vote. If we consider "the community" to be (from, say, a moderation perspective) the people that interact in official spaces, then Matrix bots selling weed are part of "the community". In general, any time you say "the community", there's probably a more specific term for the group of people you want to define, so allow me to turn the question around a little bit: what do _you_ mean when you say "the community", and why is that important to strictly define?
</details>
...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/281#issuecomment-3350855714">link</a>)</summary>

I would go as far as to say that the PolyMC question is exactly the kind of question that the SC _should not have to answer_. If the SC has to make these kinds of decisions, it's already failed at its primary job, which is to _delegate_. "Should we allow packages with hostile upstreams" might be an SC question, though I would say even that falls under nixpkgs core now, but "is this upstream hostile enough" should never be. 
</details>
...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/339#issuecomment-3350907948">link</a>)</summary>
