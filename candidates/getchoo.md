...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/472#issuecomment-3395845327">link</a>)</summary>

Yes, I support this proposal

For the simple reason that if the SC is split even on the confidence of itself, it's very likely already dysfunctional
</details>
...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/190#issuecomment-3396365808">link</a>)</summary>

Organizationally, I would push for an amendment requiring members of the SC to regularly update their Conflict of Interest statements throughout their time in office when necessary, and on (reasonable) request. While I do *somewhat* agree with the SC statement that this wouldn't of quelled all controversy, I believe the way this news was dropped was a big shock to many (myself included) and did not at all inspire more trust in members of office; in contrast, properly disclosing this would've helped likely helped more people give members some benefit of the doubt, and is frankly just what the community deserves

Personally, I would speak out about the update, as well as any drastic changes or conflicts in decision-making I may notice from the member as time goes on
</details>
...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/474#issuecomment-3395857360">link</a>)</summary>

I don't think there's much the SC can practically (or reasonably) do about this, aside from enabling the official Wiki Team to continue making a better alternative that more people use and organically gets ranked higher
</details>
...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/434#issuecomment-3396678540">link</a>)</summary>
...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/326#issuecomment-3396597366">link</a>)</summary>

Quoting from my response [last year](https://github.com/NixOS/SC-election-2024/issues/18#issuecomment-2381934483):
...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/265#issuecomment-3396529764">link</a>)</summary>

I seem to have had the same reaction as @JulienMalka here:

> I don't think answering this question without having a first-hand experience of the dynamics inside the Steering Committee makes a lot of sense.

I'm not at all opposed to this possibility, but I think it's important to get more insight into how the SC currently functions and *could* function with a different set of members before having much of a stance on this
</details>
...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/477#issuecomment-3396290716">link</a>)</summary>

I'd definitely find it odd

Community members are free to do what they please outside of our official spaces of course - and in isolation, I'm not sure of much action to be taken against this, aside from just finding it odd. **However**, I do think it would be important to consider this kind of behavior in the same context as the participants actions *in* official spaces (as at this scale, it's affecting a wide number of people; part of the community), as well as the moderation decisions in response to those actions
</details>
...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/407#issuecomment-3396677006">link</a>)</summary>

> how do you regard the topic of SC transparency in light of @Gabriella439's recommendations, if not more generally?

I believe it is key in keeping faith in the SC

As someone on the outside...I honestly haven't really known what the SC was ever actively considering or doing at any given time. That's a problem.

And even when I *did* know when a decision was being made, I wasn't sure how it was, why it was, or by whom. It makes it quite frustrating, especially when I know my votes this election would've probably been very different if certain information hadn't been "leaked"

> Further, how would you concretely enact these views in the SC, if elected?

As I said in https://github.com/NixOS/SC-election-2025/issues/195#issuecomment-3396411234: 

> I would [...] like to increase the transparency of the SC itself by publishing all vote counts, creating meeting minutes, and hosting town halls for community question. [...] There should be clear amendments describing the relationship between our moderation team and SC [...] and clear, enforceable transparency requirements for each

And as I said in https://github.com/NixOS/SC-election-2025/issues/199#issuecomment-3396516989:

> I would also like to introduce regular "town halls" where members of the community can ask the SC questions directly, as well as encourage members of the SC to provide more direct means of communication (i.e., e-mail, Matrix, Discord). I would personally use these latter two options as frequently as I could
</details>
...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/470#issuecomment-3395850438">link</a>)</summary>

No, I am not a part of a coalition

I have had interactions with many of the candidates here though, and  should probably mention I'm very close friends with @pluiedev and @Scrumplex - though we haven't really talked much about the election lol
</details>
...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/464#issuecomment-3396331391">link</a>)</summary>

I don't really agree with mods being cops, but going along with the rest of the question:

> If moderators are indeed tasked with enforcing rules, who then plays the role of the judiciary in our governance model?

Generally, also moderators

Assuming your definition of judiciary is something along the lines of "the ones who interpret the law" (with the law being our COC, shared values, etc.), mods will usually be the ones coming to the conclusion of whether or not someone's behavior is in violation of that "law". I think that's a reasonable part of the job

> Do you think mods alone should be able to decide on the punishment (especially lifetime bans)?

*Only* mods, no. In extreme cases, lifetime bans should be able to be reversed and possibly escalated to something like the SC

But generally, yes. As long as there is transparency in the process, we should be trusting our moderation team to moderate
</details>
...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/192#issuecomment-3396381600">link</a>)</summary>

In general, no

I think @rhendric made a good point on members of the SC recusing themselves in decisions affecting their team, but other than that I don't personally see much issue with it - especially if the SC properly delegated more authority to teams rather than themselves
</details>
...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/390#issuecomment-3396655962">link</a>)</summary>

As I said in https://github.com/NixOS/SC-election-2025/issues/195#issuecomment-3396411234

> My first priority would be creating a new moderation team that can sit alongside the (technical) SC and be more independent, well trusted, and transparent

> Once these things are picked up, I would like to focus on codifying them into our constitution. There should be clear amendments describing the relationship between our moderation team and SC, "checks" they have against each other, and clear, enforceable transparency requirements for each
</details>
...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/481#issuecomment-3396694100">link</a>)</summary>

I would like to *always* hold special elections - ideally as required through an amendment to our constitution
</details>
...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/199#issuecomment-3396516989">link</a>)</summary>

I am in support of public minutes for regularly scheduled meetings, including topics of conversation, points made, and votes cast. These should one day be recorded by an "Observer"-like role: an independent, trusted member of the community who can hold the SC directly accountable
...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/195#issuecomment-3396411234">link</a>)</summary>

My first priority would be creating a new moderation team that can sit alongside the (technical) SC and be more independent, well trusted, and transparent. In the course of doing that, I would also like to increase the transparency of the SC itself by publishing all vote counts, creating meeting minutes, and hosting town halls for community question

Once these things are picked up, I would like to focus on codifying them into our constitution. There should be clear amendments describing the relationship between our moderation team and SC, "checks" they have against each other, and clear, enforceable transparency requirements for each

After, I would explore further amendments that give more power to contributors and voters alike. I currently think this would be best done by giving voters clearer ways to take direct action, such as putting amendment propositions on the ballot and recalling members of office. Technical decisions of the SC should also be distributed down the chain to smaller team - like the newly created Nixpkgs Core Team
</details>
...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/482#issuecomment-3396701563">link</a>)</summary>

I think voters should have the ability to petition for a member to be recalled. Once that petition grows to a specific number of eligible voters, a special election should then be held

I believe a similar system should also exist for voters calling for a Vote of No Confidence against the entire SC
</details>
...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/342#issuecomment-3396650849">link</a>)</summary>

> Do you feel like SC taking on this job is adequate in the long run, or do you see it as a temporary measure? What are your next steps on pursuing a sponsorship policy?

No. I would like to make a dedicated team around this for events, that takes into account existing community input on potential sponsors, as well as actively responds to feedback based on their considerations/decisions

We shouldn't need to repeat the Anduril situation each and every time a company the community doesn't approve of attempts to get involved. Instead, there should be procedures in place to evolve our policies to stay in-line with community sentiment
</details>
...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/283#issuecomment-3396567548">link</a>)</summary>

I don't think there's anything for the SC to directly do with Lix

But generally, I think it would be good to always keep an open line with them in regards to things like security issues, ecosystem development, and any potential standardization efforts that might take place. I'd also like to ensure we acknowledge and reasonably account for multiple implementations of `nix` in projects under the SC's jurisdiction (like Nixpkgs), as well as openly encourage collaboration where we can
</details>
...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/197#issuecomment-3396490798">link</a>)</summary>

I'd like to coordinate with the (future) moderation team on what actions we should take on how they interact in our spaces, as well as how we interact with their code

Some questions I'd personally raise are how we should handle their promotions on places such as the Discourse, mentions of them and their products in documentation, and how projects like the [Foundation's fork of their installer](https://github.com/NixOS/experimental-nix-installer) and Nix itself should distance themselves from DetSys' products
</details>
...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/337#issuecomment-3396612541">link</a>)</summary>

> [!NOTE]
> This is a copy of my response from [last year](https://github.com/NixOS/SC-election-2024/issues/34#issuecomment-2381993226)
...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/336#issuecomment-3396607267">link</a>)</summary>

I agree with @leona-ya and @adamcstephens here
</details>
...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/196#issuecomment-3396469769">link</a>)</summary>

As someone who has been contributing to Nix recently, I don't think it's been all that bad of an experience as is! I've found the Nix team fairly communicative with their minutes, fast to respond to issues/PRs, and are more than willing to hold my hand a bit. I'd like to do my best to keep enabling that

But if I was giving suggestions, I think it would be interesting to take some notes from Lix - namely in their many DX improvements, modern async stuff with the `kj` runtime(?), refactors, new testing system, and release notes system. I've always found that stuff to be nicer there, and a lot more welcoming
</details>
...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/479#issuecomment-3396685867">link</a>)</summary>

I'm not sure it's best as a Conflict of Interest, but I think formal alliances/coalitions should be listed if a nominee is a part of them (sorta similar to a political party)
</details>
...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/340#issuecomment-3396638116">link</a>)</summary>

I fully agree with @niklaskorz and @JulienMalka 
</details>
...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/281#issuecomment-3396552483">link</a>)</summary>
...
I would recuse myself from this. I work on Prism Launcher, and maintain it in Nixpkgs

But I think @K900 had a good response on this above

> What should be the policy on MIC participation?

I'd lean towards an outright ban on MIC sponsoring events - or at the very least, not being able to display, advertise, or otherwise get anything from said sponsorship

Past that it's longer conversation

> What should be the policy for telemetry?

I think I'd mostly agree with what the current SC concluded
</details>
...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/341#issuecomment-3396640549">link</a>)</summary>

https://github.com/NixOS/SC-election-2025/issues/197#issuecomment-3396490798 also applies here I believe :)
</details>
...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/339#issuecomment-3396634266">link</a>)</summary>

I think what a lot of our documentation teams are doing is great, and I would like to see more coordination between them since

> A new NixOS user will look at the NixOS manual for help: but really, they are using Nix+Nixpkgs+NixOS stack. For a beginner, it is not clear why there would be three manuals, and where the boundaries lie, and which manual they need (especially when interacting with a layering violation).

I very much agree that this is the core issue

My main proposition for the "glue" between all of these manuals (and filling those layering violation gaps) is wiki.nixos.org. It seems natural to me as it already covers all topics, and is meant to provide snippet-y information while linking back to full sources (the manuals)
</details>
...
<details>
<summary>Answer (<a href="https://github.com/NixOS/SC-election-2025/issues/338#issuecomment-3396619650">link</a>)</summary>

I generally agree with @pluiedev. Different licenses work for different purposes, and I think it would be best to relegate that decision to teams and trust their best judgement
</details>
